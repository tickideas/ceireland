  ...
  return (
    <aside className="h-full space-y-6">
      <div className="text-center">
        <h3 className="text-lg font-semibold text-gray-900">{data.title || 'Daily Devotional'}</h3>
      ...
      {data.scripture && (
        <section>
          ...
          <p className="text-sm italic text-gray-900 bg-blue-50 rounded-md p-3">{data.scripture}</p>
        </section>
      )}
      ...
      <section>
        <h4 className="text-sm font-semibold text-blue-700 mb-2">Prayer / Confession</h4>
        <div className="space-y-3 text-sm leading-6 text-gray-800">
      ...
      <section>
        <h4 className="text-sm font-semibold text-blue-700 mb-2">Further Study</h4>
      ...
      <div>
        <a
          ...
          className="inline-block text-blue-600 hover:text-blue-700 text-xs font-medium"
        >
          Read on Rhapsody →
        </a>
      </div>
